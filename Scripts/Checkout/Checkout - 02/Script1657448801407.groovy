...
Mobile.setText(findTestObject('Checkout/Body/android.widget.EditText - your.emailgmail.com'), 'sdfsdf', 0)

Mobile.verifyElementVisible(findTestObject('Checkout/Body/android.widget.EditText - 628123456789'), 0)

Mobile.setText(findTestObject('Checkout/Body/android.widget.EditText - 628123456789'), '', 0)

Mobile.verifyElementVisible(findTestObject('Checkout/Body/android.widget.EditText - Your Address'), 0)

Mobile.setText(findTestObject('Checkout/Body/android.widget.EditText - Your Address'), '', 0)
...
Mobile.tap(findTestObject('Checkout/Bottom/android.widget.Button - PROCESS CHECKOUT'), 0, FailureHandling.STOP_ON_FAILURE)
